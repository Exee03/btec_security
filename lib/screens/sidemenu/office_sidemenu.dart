...
class OfficeScreenSidemenu extends StatefulWidget {
  OfficeScreenSidemenu({this.menu, this.user});
  final Menu menu;
  final FirebaseUser user;

  @override
  _OfficeScreenSidemenuState createState() => _OfficeScreenSidemenuState();
}

class _OfficeScreenSidemenuState extends State<OfficeScreenSidemenu> {
